...
namespace MvcProduct.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            IQueryable<string> typeQuery = from p in _context.Product
                                            orderby p.Type
                                            select p.Type;
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Manufacturer,RegisterDate,Type,Price")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Manufacturer,RegisterDate,Type,Price")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
